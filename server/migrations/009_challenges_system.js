...
export async function runChallengesSystemMigration() {
  ...
  `);
    ...
    await run(`INSERT IGNORE INTO app_settings (setting_key, setting_value, setting_type, category, label)
     VALUES ('challenge_reward_defaults', ?, 'json', 'challenges', 'Challenge Reward Defaults')`, [defaults]);
}
//# sourceMappingURL=009_challenges_system.js.map