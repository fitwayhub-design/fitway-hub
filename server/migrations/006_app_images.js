...
export async function runAppImagesMigration() {
    const tbl = await get(`SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'app_images'`);
    if (!tbl) {
        await run(`
...
//# sourceMappingURL=006_app_images.js.map