...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex h-full flex-1 items-center justify-center gap-1.5 rounded-[8px] px-3 py-1 text-[13px] font-semibold whitespace-nowrap text-muted-foreground transition-all outline-none select-none",
